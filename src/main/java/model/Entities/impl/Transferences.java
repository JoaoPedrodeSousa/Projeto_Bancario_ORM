...
@Entity
public class Transferences extends Log {
    @Column(name = "id_destiny_Account")
    private Integer idDestinyAccount;

    public Transferences(Integer id, String type, Double value, LocalDate date, Integer idOriginAccount, Integer idDestinyAccount) {
